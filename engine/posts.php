...
<div <?php post_class(); ?>>
<h1 class="jacbt_post_title"><?php if ( is_single() ){
  the_title();
} else {
  ?><a class="jacbt_post_title_link"
	href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a><?php
} ?></h1>
<div class="jacbt_meta_wrapper"><span
  class="jacbt_author_credit jacbt_post_meta jacbt_post_meta_left">Posted
by <a class="jacbt_author_credit jacbt_post_meta"
	href="<?php get_author_posts_url( get_the_author_meta( 'display_name' ) );?>"><?php echo get_the_author(); ?></a></span>
<span class="jacbt_author_credit jacbt_post_meta jacbt_post_meta_right">Published
...
<p><?php wp_link_pages( $pag_post_settings ); ?> <?php 
the_content(__('Continue Reading &rarr;', 'bicicletta'));
?>
<div class="jacbt_post_meta jacbt_post_tags jacbt_meta_wrapper"><?php echo get_the_tag_list( __( 'Tagged: ', 'bicicletta'), ', ', '.' ); ?>
</div>
<?php
if ( is_single() ) {
  $previous_link = '';
...
<div class="jacbt_comment_wrapper"><?php comments_template(); ?></div>
